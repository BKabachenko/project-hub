    ...
    return (
      <>
        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          <div id={triggerDescriptionId} className='sr-only left-0 top-0'>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className='-m-0.5 ml-2 w-5 cursor-pointer rounded-sm p-0.5 hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none'
                            >
                              <XCircle
                                className={cn(
                                  'h-3 w-3',
